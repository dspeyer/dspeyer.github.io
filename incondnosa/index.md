<!--  pandoc -s --toc -c theme.css -T "Incondnosa" --metadata title="No Compulsion; No Drudgery; No Sacrifice" < index.md > index.html -->

# Starting Insight: Fixing Backwardness
...
After the [F'nar raid](/hfy/An_undefended_human_world.html), Incondnosa eventually decided to get its military a bit more organized.
